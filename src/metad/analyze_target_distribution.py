...
from metad.peaks import detect_peaks, analyze_peaks
from metad.config_manager import load_config
from metad.potentials import constant,  corrected_cos3d_potential
from metad.utils import make_nested_grid, make_grid, natural_sort,import_custom_potential
...
def main() -> None:
    cfg = load_config()
    plt_stride = int(cfg.p_plot_stride/cfg.stride)
